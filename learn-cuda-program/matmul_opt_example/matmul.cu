// 2025.2.13  
// 
// 来自于 https://github.com/xgqdut2016/hpc_project/tree/main/cuda/matrix 的例子
// 两种矩阵乘：
//  V1 没有任何优化的矩阵乘
//  V2 引入了shared Mem 的矩阵乘
#include <stdio.h>
#include <sys/time.h>
#include <cuda.h>
...
// V2 使用到了 shared Mem的GEMM --- 利用内存层次优化了访存
// 任务规划和V1保持一致
//
//
