# Fork from https://github.com/XiaobingSuper/fused_linear_triton/blob/master/triton_ops/activation.py
# 
...
def gelu(x):
    ...
    return 0.5 * x * (1 + tanh(tl.sqrt(2 / math.pi) * (x + 0.044715 * x * x * x)))
